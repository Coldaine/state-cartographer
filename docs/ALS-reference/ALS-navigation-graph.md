...
Extracted from the upstream ALAS (AzurLaneAutoScript) codebase, April 2026. See [ALS-overview.md](ALS-overview.md) for the local clone and launch workflow used in this repo.
