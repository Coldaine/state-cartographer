...
| `docs/vlm/VLM-overview.md` | Current operational bucket for multimodal capability and usage direction |
| `docs/project/north-star.md` | Goals #10 and #11 assume this exists (rich escalation) |
| `ALS-live-ops.md` | Hard rules for when to escalate (human takeover, duplicates) |
| `docs/runtime/runtime-overview.md` | Current runtime bucket for escalation, recovery, and operator boundaries |
